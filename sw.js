const CACHE_NAME="badamoa-mobile-v2";
const APP_FILES=["./","./?mode=demo","./index.html","./manifest.webmanifest","./assets/app-icon.svg","./css/styles.css","./css/recommendation.css","./css/mobile-pwa.css","./js/data.js?v=20260730-facilities","./js/storage.js","./js/app.js?v=20260730-facilities"];
