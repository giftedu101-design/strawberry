const CACHE_NAME="badamoa-mobile-v7";
const APP_FILES=["./","./?mode=demo","./index.html","./manifest.webmanifest","./assets/app-icon.svg","./css/styles.css","./css/recommendation.css","./css/mobile-pwa.css","./css/reference-inspired.css","./js/data-facilities.js","./js/storage.js","./js/app-launch.js"];
